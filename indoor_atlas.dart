...
// Wayfinding mode constants
class IAWayfindingMode {
  static const int DEFAULT = 0;
  static const int EXCLUDE_INACCESSIBLE = 1;
  static const int EXCLUDE_ACCESSIBLE_ONLY = 2;
}
...
class IndoorAtlas {
  ...
  // Estado de geocercas activadas para tracking visual
  static final Set<String> _triggeredGeofenceIds = Set.identity();

  // destino actual (para marcar en UI)
